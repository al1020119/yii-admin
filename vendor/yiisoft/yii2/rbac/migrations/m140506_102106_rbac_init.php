...
class m140506_102106_rbac_init extends \yii\db\Migration
{
    ...
    public function up()
    {
        ...
        if ($this->isMSSQL()) {
            $this->execute("CREATE TRIGGER dbo.trigger_item_child
            ...
            IF COLUMNS_UPDATED() > 0
                ...
                IF @old_name <> @new_name
                    BEGIN
                        ALTER TABLE item_child CHECK CONSTRAINT FK__auth_item__child;
                    END
                END
                ELSE
                    BEGIN
    ...
    public function down()
    {
        ...
        if ($this->isMSSQL()) {
            $this->execute('DROP TRIGGER dbo.trigger_item_child;');
        }
